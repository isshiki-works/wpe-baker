...
| AMF headers（AMD AMF 头文件，驱动运行时提供 amfrt64.dll） | `v1.5.2` | MIT | https://github.com/GPUOpen-LibrariesAndSDKs/AMF | 否 |
...
许可文本：`encoder\licenses\{ffmpeg,x264,x265,nv-codec-headers,amf-headers,llvm,mingw}\`（RC8 已在位）、
