    ...
    public static Dictionary<string, string> Sections(string language)
    {
        ...
        return new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ["analyze"] = string.Join(Environment.NewLine,
                ...
                "  [--properties-source wpe|defaults (default wpe)] [--properties JSON]",
                ...
                "  [--live-overlays preserve|foreground]  reorders independent live text/particle trees only;",
            ...
            ["bake"] = string.Join(Environment.NewLine,
                ...
                "  [--encoder software|auto|nvenc|qsv|amf] [--encode-slots N] [--group-parallel N] [--lang zh|en]",
                "wpe-baker bake REQUEST.json [--tools TOOLS.json] [--encoder software|auto|nvenc|qsv|amf]",
            ...
            ["measure-official"] = string.Join(Environment.NewLine,
                ...
                "  verdict.worth_baking compares the graphics domain against igpu_watts_threshold (default 1 W)."),
